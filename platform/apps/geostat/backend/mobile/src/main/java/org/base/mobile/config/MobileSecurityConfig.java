...
/**
 * Minimal security config for standalone mobile mode.
 * All /mobile/** and /mobile-text/** endpoints are public (read-only data).
 */
@Configuration
@EnableWebSecurity
@ConditionalOnProperty(name = "security.type", havingValue = "mobile")
