...
public class SdmxCompatibilityController {
    ...
    @TenantScopeExemption(value = TenantScopeExemption.Kind.DEFAULT_CONTRACT, reason = "contractCode is optional on the SDMX surface; without it the approved default contract is served and enforced.")
