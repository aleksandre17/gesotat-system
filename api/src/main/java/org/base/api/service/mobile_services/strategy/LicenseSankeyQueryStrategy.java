...
import org.base.api.service.mobile_services.params.LicenseGenderParams;
import org.base.api.service.mobile_services.params.QueryParams;
import org.base.api.service.mobile_services.params.LicenseSankeyParams;
...
public class LicenseSankeyQueryStrategy implements TableQueryStrategy<LicenseSankeyParams> {
    ...
    public void configureQuery(QueryBuilder query, QueryParams<LicenseSankeyParams> params) {
        ...
        query.appendSubQuery("genderAgeQuery", qb -> qb
            ...
            .append("CASE ")
            .append(" WHEN t.gender = 1 AND GROUPING(t.year) = 1 THEN 1 ")
            .append(" WHEN t.gender = 1 AND GROUPING(t.year) = 0 THEN 2 ")
            .append(" WHEN t.gender = 2 AND GROUPING(t.year) = 1 THEN 3 ")
            .append(" WHEN t.gender = 2 AND GROUPING(t.year) = 0 THEN 4 ")
            .append(" ELSE 5 ")
            ...
            .addFilter(new QueryBuilder.InFilter("t.gender", List.of(1, 2), "IN"))
